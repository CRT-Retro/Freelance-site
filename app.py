from flask import Flask, g, request, jsonify, session, redirect, url_for, abort, render_template, render_template_string, flash
...
from markupsafe import escape   # 🔥 اینجا اضافه شد
